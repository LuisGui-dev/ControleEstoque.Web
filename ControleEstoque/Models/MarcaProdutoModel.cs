    ...
    public class MarcaProdutoModel
    {
        ...
        public static MarcaProdutoModel RecuperarPeloId(int id)
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                {
                    commando.Connection = conexao;
                    commando.CommandText = "select * from marca_produto where (id = @id)";
        ...
        public static bool ExcluirPeloId(int id)
        {
            ...
            if (RecuperarPeloId(id) != null)
            {
                using (var conexao = new SqlConnection())
                {
                    ...
                    {
                        commando.Connection = conexao;
                        commando.CommandText = "delete from marca_produto where (id = @id)";
                ...
                using (var commando = new SqlCommand())
                {
                    ...
                    if (model == null)
                    {
                        commando.CommandText =
                            "insert into marca_produto (nome, ativo) values (@nome, @ativo); select convert(int, scope_identity()) ";
                    ...
                    {
                        commando.CommandText = "update marca_produto set nome=@nome, ativo=@ativo where id = @id ";
