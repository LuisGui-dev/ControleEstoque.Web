        ...
        public int Salvar()
        {
            ...
            using (var conexao = new SqlConnection())
            {
                ...
                using (var comando = new SqlCommand())
                {
                    ...
                    {
                        comando.CommandText =
                            "insert into estado (nome, uf, id_pais, ativo) values (@nome, @uf, @id_pais, @ativo); select convert(int, scope_identity())";

                        comando.Parameters.Add("@nome", SqlDbType.VarChar).Value = Nome;
                        comando.Parameters.Add("@uf", SqlDbType.VarChar).Value = UF;
                        comando.Parameters.Add("@id_pais", SqlDbType.Int).Value = IdPais;
                    ...
                    {
                        comando.CommandText =
                            "update estado set nome=@nome, uf=@uf, id_pais=@id_pais, ativo=@ativo where id = @id";
